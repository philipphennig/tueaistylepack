# tueaistylepack
Style pack for the Tübingen AI Center, with templates for slides, theses, and more. 
...
* a general color scheme providing the color scheme of the center
* a template for beamer slides, with various macros
* a template for Master's and Bachelor's theses that follows the content guidelines of the Tübingen CS department. 
